<template>
  <div class="flex flex-col text-white min-h-screen bg-slate-200">
    ...
    <nav class="bg-gradient-to-r from-emerald-700 to-emerald-600 p-4 shadow-md">
      <div class="container mx-auto">
        <div class="flex justify-between items-center">
          ...
          <div class="hidden space-x-8 lg:-my-px lg:ml-10 lg:flex">
            <NavLink :href="route('courses.available')" :active="route().current('courses.available')" class="uppercase">
              Visi kursai
            </NavLink>
            <NavLink :href="route('enrollments.learner.index')" :active="route().current('enrollments.learner.index')"
              class="uppercase">
              Mano įsiregistravimai
            </NavLink>
            <NavLink :href="route('demodrop.index')" :active="route().current('demodrop.index')" class="uppercase">
              Perklausos
            </NavLink>
          </div>
                ...
                <template #trigger>
                  <span class="inline-flex rounded-md">
                    <PrimaryButton type="button"
                      class="inline-flex items-center px-3 py-2 border border-transparent bg-emerald-700 text-lg leading-4 font-medium rounded-md focus:outline-none transition ease-in-out duration-150">
      ...
      <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="mt-4 lg:hidden">
        <div class="pb-3 space-y-1">
          ...
          <ul>
            <li>
              <ResponsiveNavLink :href="route('courses.available')" :active="route().current('courses.available')">
                Visi kursai
              </ResponsiveNavLink>
            </li>
            <li>
              <ResponsiveNavLink :href="route('enrollments.learner.index')"
                :active="route().current('enrollments.learner.index')">
                Mano įsiregistravimai
              </ResponsiveNavLink>
            </li>
            <li>
              <ResponsiveNavLink :href="route('demodrop.index')" :active="route().current('demodrop.index')">
                Perklausos
              </ResponsiveNavLink>
            </li>
